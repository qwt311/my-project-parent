/**
 * Created by qiaowentao on 2016/11/15.
 */
$(function(){
...
function importExcel() {
    ...
    if(isExcel(excel)) {
        ...
        layer.msg("导入中请等待...", {shade: [0.5, '#000'], scrollbar: false, offset: '50%', time: 1000}, function () {
            $.ajaxFileUpload({
                url: contextPath + '/resource/import/excel',     //需要链接到服务器地址
                secureuri: false,
                type: 'post',
                ...
                success: function (data) {          //相当于java中try语句块的用法
                    ...
                    layer.msg(data.attach, {shade: [0.5, '#000'], scrollbar: false, offset: '50%', time: 3000}, function () {
                        window.location.href = contextPath + "/resource/index";
                    });
